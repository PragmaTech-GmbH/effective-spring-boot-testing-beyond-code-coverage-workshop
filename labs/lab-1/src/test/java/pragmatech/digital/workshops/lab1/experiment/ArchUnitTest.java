...
import pragmatech.digital.workshops.lab1.controller.ThreadController;
...
class ArchUnitTest {
  ...
  static final ArchRule layeredArchitectureRuleShouldBeRespected = layeredArchitecture()
    ...
    .ignoreDependency(ThreadController.class, pragmatech.digital.workshops.lab1.repository.BookRepository.class);
  ...
  static final ArchRule classesShouldNotCallLocalDateNowDirectly = noClasses()
    ...
    .and().resideInAPackage("pragmatech.digital.workshops.lab1..")
    .and().doNotHaveSimpleName("ThreadController")
