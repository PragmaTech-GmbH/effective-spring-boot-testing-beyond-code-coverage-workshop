...
import pragmatech.digital.workshops.lab4.controller.ThreadController;
...
class ArchUnitTest {
  ...
  static final ArchRule layeredArchitectureRuleShouldBeRespected = layeredArchitecture()
    ...
    .ignoreDependency(ThreadController.class, pragmatech.digital.workshops.lab4.repository.BookRepository.class);
