...
import pragmatech.digital.workshops.lab3.controller.ThreadController;
 ...
 */
@AnalyzeClasses(
  packages = "pragmatech.digital.workshops.lab3",
...
class ArchUnitTest {
  ...
  static final ArchRule layeredArchitectureRuleShouldBeRespected = layeredArchitecture()
    ...
    .ignoreDependency(ThreadController.class, pragmatech.digital.workshops.lab3.repository.BookRepository.class);
  ...
  static final ArchRule classesShouldNotCallLocalDateNowDirectly = noClasses()
    ...
    .and().resideInAPackage("pragmatech.digital.workshops.lab3..")
    .and().doNotHaveSimpleName("ThreadController")
